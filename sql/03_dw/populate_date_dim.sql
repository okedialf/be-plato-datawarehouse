...
-- Covers 2010-01-01 through 2040-12-31.
-- Uganda Fiscal Year runs July–June (e.g., Jul 2024–Jun 2025 = FY2025).
-- =============================================================================
...
SELECT
    ...
    END                                                AS "FY",
    -- Fiscal quarters within Uganda FY (Q1=Jul-Sep, Q2=Oct-Dec, Q3=Jan-Mar, Q4=Apr-Jun)
    CASE
    ...
    END                                                AS "Quarter"
FROM
    GENERATE_SERIES('2010-01-01'::DATE, '2040-12-31'::DATE, '1 day'::INTERVAL) AS d
